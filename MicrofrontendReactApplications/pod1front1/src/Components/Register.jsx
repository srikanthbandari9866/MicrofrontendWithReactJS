...
export default () => {
  ...
  async function handleSubmit(e){
    ...
    && department != "" && (confirmPassword == password)){
        const userdata = {userName, employeeId, gender, phoneNumber, email, password, department, location,imagePath}
        // console.log(userdata)
        let result = await axios.post(`http://localhost:8018/api/Users`, userdata).then(response => {
            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      ...
                      <p style={{ color: "brown" }}>{formErrors.employeeId}</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-outline mb-4">
                  ...
                  <p style={{ color: "brown" }}>{formErrors.location}</p>
                </div>
                ...
                <div class="d-md-flex justify-content-start align-items-center mb-4 py-2">
                  ...
                  <div class="form-check form-check-inline mb-0">
                    ...
                    <p style={{ color: "brown" }}>{formErrors.gender}</p>
                  </div>
                ...
                <div class="form-outline mb-4">
                  ...
                  <p style={{ color: "brown" }}>{formErrors.department}</p>
                </div>
                ...
                <div class="form-outline mb-4">
                  ...
                  <p style={{ color: "brown" }}>{formErrors.confirmPassword}</p>
                </div>
