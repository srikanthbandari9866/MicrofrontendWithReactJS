...
export default (props) => {
    const setResultsG = props.setResultsG
    ...
    return (<>
        <div className="search-bar">
            ...
            <input type="text" placeholder="Search with Gender" value={input}
...
// export default (props) => {
//     const setResults = props.setResultsG
//     const setContent = props.setContentG
//     const [input, setInput] = useState("");
...
//                     return value && user && (user.gender && user.gender.toLowerCase().includes(value) || user.gender && user.gender.includes(value))
//                 });
//                 setResults(results)
//             })
//     }
