...
export default (props) => {
    const setResultsM = props.setResultsM
    ...
    return (<>
        <div className="search-bar">
            ...
            <input type="text" placeholder="Search with Mobile Number" value={input}
...
// export default (props) => {
//     const setResults = props.setResultsM
//     const setContent = props.setContentM
//     const [input, setInput] = useState("");
...
//                     return value && user && user.phoneNumber && user.phoneNumber.includes(value)
//                 });
//                 setResults(results)
//             })
//     }
