...
export default (props) => {
    const setResultsE = props.setResultsE
    ...
    return (<>
        <div className="search-bar">
            ...
            <input type="text" placeholder="Search with Email" value={input}
...
// export default (props) => {
//     const setResults = props.setResultsE
//     const setContent = props.setContentE
//     const [input, setInput] = useState("");
