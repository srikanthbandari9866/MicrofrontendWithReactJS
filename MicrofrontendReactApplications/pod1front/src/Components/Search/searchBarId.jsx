...
export default (props) => {
    const setResultsI = props.setResultsI
    ...
    return (<>
        <div className="search-bar">
            ...
            <input type="text" placeholder="Search with Employee Id" value={input}
...
// export default (props) => {
//     const setResults = props.setResultsI
//     const setContent = props.setContentI
//     const [input, setInput] = useState("");
...
//                     return value && user && user.employeeId && user.employeeId.includes(value)
//                 });
//                 setResults(results)
//             })
//     }
